...
class WEBKIT_GPU_EXPORT ContextProviderInProcess
 ...
 public:
  ...
  /// M: shared context of main thread. if SW Renderer mode @{
  virtual bool HasHardwareCompositor() OVERRIDE;
  virtual void SetHasHardwareCompositor(bool has_hardware_compositor) OVERRIDE;
  /// @}
 protected:
 ...
 private:
  ...
  base::Lock compositor_check_lock_;
  bool has_hardware_compositor_;
