...
public class PasswordDatabase {
    ...
    public PasswordDatabase(final Context context, final String databaseFile) {
        Xlog.d(LOGTAG, "constructor " + databaseFile);
        new Thread() {
            @Override
            public void run() {
    ...
    private void initDatabase(Context context, String databaseFile) {
        ...
        if (mDatabase == null) {
            ...
            Xlog.e(LOGTAG, "Unable to open or create " + databaseFile);
            return;
        }
        ...
        synchronized (this) {
            while (!mInitialized) {
                try {
                    ...
                    Xlog.e(LOGTAG, "Caught exception while checking initialization", e);
                }
            }
        }
    ...
    public void setUsernamePassword(String schemePlusHost, String[] data, String[] data16, boolean remember) {
        ...
        Xlog.d(LOGTAG, "setUsernamePassword " + schemePlusHost + ", " + remember);
        ...
        if (remember) {
            Xlog.d(LOGTAG, "setUsernamePassword1 " + data[FIELD_SIGNON_REALM] + ", " + data[FIELD_ORIGIN_SIGNON_REALM]);
            Xlog.d(LOGTAG, "setUsernamePassword2 " + data[FIELD_ORIGIN_SPEC] + ", " + data[FIELD_ACTION_SPEC]);
        }
        ...
        if (remember) {
            Xlog.d(LOGTAG, "setUsernamePassword3 " + data16[FIELD_USERNAME_NAME] + ", " + data16[FIELD_USERNAME_VALUE]);
            Xlog.d(LOGTAG, "setUsernamePassword4 " + data16[FIELD_PASSWORD_NAME] + ", " + data16[FIELD_PASSWORD_VALUE]);
        }
    ...
    public RequestRetData getUsernamePassword(String schemePlusHost) {
        ...
        try {
            ...
            Xlog.e(LOGTAG, "getUsernamePassword ", e);
        } finally {
            if (cursor != null) {
                cursor.close();
            }
    ...
    public boolean hasUsernamePassword() {
        ...
        try {
            ...
            Xlog.e(LOGTAG, "hasUsernamePassword", e);
        } finally {
