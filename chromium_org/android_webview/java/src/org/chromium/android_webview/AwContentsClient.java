...
public abstract class AwContentsClient {
    ...
    private class AwContentViewClient extends ContentViewClient {
        ...
        public void onBackgroundColorChanged(int color) {
            ...
            Xlog.d(TAG, "onBackgroundColorChanged, CachedBGColor = " + mCachedRendererBackgroundColor);
        }
    ...
    final int getCachedRendererBackgroundColor() {
        ...
        Xlog.d(TAG, "getCachedRendererBackgroundColor, CachedBGColor = " + mCachedRendererBackgroundColor);
