...
public class AwLayoutSizer {
    /// M: add log
    private static final String TAG = "AwLayoutSizer";
    ...
    public void onContentSizeChanged(int widthCss, int heightCss) {
        if (mEnableLog) {
            Xlog.d(TAG, "onContentSizeChanged " + widthCss + ", " + heightCss + ", " + mPageScaleFactor);
        }
    ...
    public void onPageScaleChanged(float pageScaleFactor) {
        if (mEnableLog) {
            Xlog.d(TAG, "onPageScaleChanged " + mContentWidthCss + ", " + mContentHeightCss + ", " + pageScaleFactor);
        }
    ...
    public void onSizeChanged(int w, int h, int ow, int oh) {
        if (mEnableLog) {
            Xlog.d(TAG, "onSizeChanged " + w + ", " + h + ", " + ow + ", " + oh);
        }
        mLastWidth = w;
        mLastHeight = h;
    ...
    public void onLayoutChange() {
        if (mEnableLog) {
            Xlog.d(TAG, "onLayoutChange " + mLastWidth + ", " + mLastHeight + ", " + mLastMeasuredPageScaleFactor);
        }
        updateFixedLayoutSize(mLastWidth, mLastHeight, mLastMeasuredPageScaleFactor);
    }
    ...
    private void setFixedLayoutSize(int widthDip, int heightDip) {
        if (mEnableLog) {
            Xlog.d(TAG, "setFixedLayoutSize " + widthDip + ", " + heightDip);
        }
