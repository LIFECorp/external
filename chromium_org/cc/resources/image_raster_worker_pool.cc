...
ImageRasterWorkerPool::~ImageRasterWorkerPool() {
  ...
  LOG(INFO) << "[ImageRasterWorkerPool::Destructor] [" << this << "][" << getpid() << "]["
                << gettid() << "] image_task=[" << image_tasks_.size() << "]";
...
void ImageRasterWorkerPool::ScheduleTasks(RasterTask::Queue* queue) {
  ...
  for (RasterTaskVector::const_iterator it = raster_tasks().begin();
    ...
    LOG(INFO) << "[SchduleTasks] [" << this << "][" << getpid() << "][" << gettid()
                << "] resource=[" << task->resource() << "] newImageTask=[" << new_image_task.get() << "]";
...
void ImageRasterWorkerPool::OnRasterTaskCompleted(
  ...
  LOG(INFO) << "[ImageRasterWorkerPool::OnRasterTaskCompleted] [" << this << "][" << getpid() << "][" << gettid()
                << "] task=[" << task.get() << "]";
}
