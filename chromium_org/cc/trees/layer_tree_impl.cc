...
void LayerTreeImpl::SetRootLayerScrollOffsetDelegate(
  ...
  /// M: for ALPS01438675
  /// SetScrollOffsetDelegate will set the MaxScrollRange and calculated by total_page_scale.
  /// So move the SetScrollOffsetDelegate after SetTotalPageScaleFactor
  if (root_scroll_layer_) {
      root_scroll_layer_->SetScrollOffsetDelegate( 
              root_layer_scroll_offset_delegate_);
  }
