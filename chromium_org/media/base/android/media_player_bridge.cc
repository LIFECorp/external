...
/// M: following mechanism will cause bug which let control shows 1:40
/// since you don't know the duration yet, seek is not so important. so we disable it @{
...
// is available.
static const int kTemporaryDuration = 0;
/// @}
