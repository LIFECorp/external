...
RenderObject* RenderWMLTextControl::layoutSpecialExcludedChild(bool relayoutChildren)
{
    Element* placeholder = toWMLInputElement(node())->placeholderElement();
...
bool RenderWMLTextControl::canBeReplacedWithInlineRunIn() const
{
    return false;
}
