...
inline RenderWMLMenuList* toRenderWMLMenuList(RenderObject* object)
{
    ASSERT_WITH_SECURITY_IMPLICATION(!object || object->isMenuList());
    return static_cast<RenderWMLMenuList*>(object);
}

// This will catch anyone doing an unnecessary cast.
void toRenderWMLMenuList(const RenderWMLMenuList*);
